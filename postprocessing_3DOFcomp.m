...
fig(1)=figure('Name','State Trajectories','Position', [50 10 600 1750]);
...
fig(4)=figure('Name','State Trajectories','Position', [50 10 600 1500]);
...
saveas(fig(4),'figures\3dofcomp_port_exclromv3_'+timestamp,'jpg')
