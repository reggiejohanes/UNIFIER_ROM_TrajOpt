...
static const rtwCAPI_Signals rtBlockSignals [ ] = { { 0 , 0 , TARGET_STRING (
 "UNIFIER_dyn/Displays&Out/TmpSignal ConversionAt_asyncqueue_inserted_for_To Workspace11Inport1"
...
"UNIFIER_dyn/Displays&Out/Add" ) , TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 0 }
, { 5 , 0 , TARGET_STRING ( "UNIFIER_dyn/Displays&Out/Add1" ) , TARGET_STRING
( "" ) , 0 , 0 , 2 , 0 , 0 } , { 6 , 0 , TARGET_STRING (
"UNIFIER_dyn/Displays&Out/Add2" ) , TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 0
} , { 7 , 0 , TARGET_STRING ( "UNIFIER_dyn/Displays&Out/Add3" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 2 , 0 , 0 } , { 8 , 2 , TARGET_STRING (
"UNIFIER_dyn/Ganging/For Each Subsystem" ) , TARGET_STRING ( "u2" ) , 0 , 0 ,
3 , 0 , 0 } , { 9 , 0 , TARGET_STRING ( "UNIFIER_dyn/UNIFIER OBM1/Cast7" ) ,
TARGET_STRING ( "" ) , 0 , 1 , 4 , 0 , 1 } , { 10 , 0 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Cast8" ) , TARGET_STRING ( "" ) , 0 , 1 , 2 , 0 , 1
} , { 11 , 0 , TARGET_STRING ( "UNIFIER_dyn/UNIFIER OBM1/Cast9" ) ,
TARGET_STRING ( "" ) , 0 , 1 , 4 , 0 , 1 } , { 12 , 1 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 12 , 0 , 1 } , { 63 , 18 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Subsystems/DEP1/DEP/Conversion/Cast" ) ,
TARGET_STRING ( "" ) , 0 , 1 , 4 , 0 , 1 } , { 64 , 18 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Subsystems/DEP1/DEP/Conversion/Transpose" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 10 , 0 , 1 } , { 65 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Subsystems/HTU/PropAndMotor/Saturation Dynamic/Switch2"
) , TARGET_STRING ( "" ) , 0 , 0 , 2 , 0 , 1 } , { 66 , 9 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Left/Subsystem/CrossProduct/Cast" )
, TARGET_STRING ( "" ) , 0 , 1 , 4 , 0 , 1 } , { 67 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Left/WingRootForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 0 , 2 , 2 , 0 , 1 } , { 68 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Left/WingRootForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 1 , 1 , 2 , 0 , 1 } , { 69 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Left/WingTipForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 0 , 2 , 2 , 0 , 1 } , { 70 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Left/WingTipForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 1 , 1 , 2 , 0 , 1 } , { 71 , 13 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Right/Subsystem/CrossProduct/Cast"
) , TARGET_STRING ( "" ) , 0 , 1 , 4 , 0 , 1 } , { 72 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Right/WingRootForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 0 , 2 , 2 , 0 , 1 } , { 73 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Right/WingRootForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 1 , 1 , 2 , 0 , 1 } , { 74 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Right/WingTipForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 0 , 2 , 2 , 0 , 1 } , { 75 , 0 , TARGET_STRING (
 "UNIFIER_dyn/UNIFIER OBM1/Aero/WingForces/Right/WingTipForces/WingRootPreLookup/Prelookup"
) , TARGET_STRING ( "" ) , 1 , 1 , 2 , 0 , 1 } , { 0 , 0 , ( NULL ) , ( NULL
) , 0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_BlockParameters
rtBlockParameters [ ] = { { 76 , TARGET_STRING (
"UNIFIER_dyn/testinput1_3dof" ) , TARGET_STRING ( "Value" ) , 0 , 13 , 0 } ,
{ 77 , TARGET_STRING ( "UNIFIER_dyn/Ganging/Constant" ) , TARGET_STRING (
"Value" ) , 0 , 2 , 0 } , { 78 , TARGET_STRING ( "UNIFIER_dyn/Ganging/zeta" )
, TARGET_STRING ( "Value" ) , 0 , 14 , 0 } , { 79 , TARGET_STRING (
"UNIFIER_dyn/fill_inputs/Constant" ) , TARGET_STRING ( "Value" ) , 0 , 2 , 0
} , { 80 , TARGET_STRING ( "UNIFIER_dyn/Ganging/For Each Subsystem/K_slope" )
...
"Value" ) , 0 , 2 , 0 } , { 129 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Subsystems/Gravity/Multiply" ) , TARGET_STRING (
"Gain" ) , 0 , 2 , 0 } , { 130 , TARGET_STRING (
"UNIFIER_dyn/UNIFIER OBM1/Subsystems/HTU/Constant" ) , TARGET_STRING (
"Value" ) , 0 , 2 , 0 } , { 131 , TARGET_STRING (
...
rtwCAPI_Signals rtRootInputs [ ] = { { 241 , 0 , TARGET_STRING (
"UNIFIER_dyn/in" ) , TARGET_STRING ( "" ) , 1 , 0 , 2 , 0 , 0 } , { 0 , 0 , (
NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_Signals
rtRootOutputs [ ] = { { 242 , 0 , TARGET_STRING ( "UNIFIER_dyn/Out1" ) ,
TARGET_STRING ( "" ) , 1 , 0 , 24 , 0 , 0 } , { 0 , 0 , ( NULL ) , ( NULL ) ,
0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_ModelParameters
rtModelParameters [ ] = { { 243 , TARGET_STRING ( "dp_VTAIL" ) , 3 , 2 , 0 }
, { 244 , TARGET_STRING ( "dp_VTAIL_INDUCED" ) , 4 , 2 , 0 } , { 245 ,
TARGET_STRING ( "dp_WING_root" ) , 5 , 2 , 0 } , { 246 , TARGET_STRING (
"dp_WING_tip" ) , 6 , 2 , 0 } , { 247 , TARGET_STRING ( "dp_DEP" ) , 9 , 2 ,
0 } , { 248 , TARGET_STRING ( "dp_HTU" ) , 11 , 2 , 0 } , { 249 ,
TARGET_STRING ( "dp_FUSE_FIN" ) , 12 , 2 , 0 } , { 250 , TARGET_STRING ( "I"
) , 0 , 10 , 0 } , { 251 , TARGET_STRING ( "S" ) , 0 , 2 , 0 } , { 252 ,
TARGET_STRING ( "m" ) , 0 , 2 , 0 } , { 253 , TARGET_STRING ( "xyz_DEP" ) , 0
, 7 , 0 } , { 254 , TARGET_STRING ( "xyz_cg" ) , 0 , 15 , 0 } , { 255 ,
TARGET_STRING ( "vtail_nodes" ) , 1 , 9 , 0 } , { 256 , TARGET_STRING (
"wing_nodes" ) , 1 , 51 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . jf0izapwy0 [ 0 ] , & rtB .
f40dvdh03c [ 0 ] , & rtB . phkvheqamq [ 0 ] , & rtB . lwgmtklpwc [ 0 ] , &
rtB . hn4ul2bos2 [ 0 ] , & rtB . i0nsydannn , & rtB . gh0om3pyty [ 0 ] , &
rtB . pd2gmgjs20 , & rtB . eljuwfhp1f [ 0 ] , & rtB . lxkh42xndm [ 0 ] , &
rtB . ecjaklyjaq , & rtB . lcnor15erx [ 0 ] , & rtB . p5rpnypkdo [ 11 ] .
gbstdhmylq , & rtB . jefg5cifsj , & rtB . jet1i0an5do [ 0 ] , & rtB .
dzpd4knetl [ 0 ] , & rtB . crx1qgibvon [ 0 ] , & rtB . jet1i0an5d [ 0 ] , &
rtB . crx1qgibvo [ 0 ] , & rtB . bzx2uazgws [ 0 ] , & rtB . iy2nxhyqc1 [ 0 ]
, & rtB . jdsvzdisey [ 0 ] , & rtB . noeiauttpl [ 0 ] , & rtB . jz0qdcsmmm [
15 ] . ijneevr0hx [ 0 ] , & rtB . jz0qdcsmmmw [ 13 ] . kz2ejerpof [ 0 ] , &
rtB . f5f1ypai11 [ 0 ] , & rtB . l3mgpdtrrg [ 0 ] , & rtB . ejdl4n31el [ 0 ]
, & rtB . pyp2bnyod5 [ 0 ] , & rtB . etlvxwxtcy [ 0 ] , & rtB . fqp13muoyo [
0 ] , & rtB . jltpjpl4zp [ 0 ] , & rtB . nluycx3bh3 [ 0 ] , & rtB .
p1lfhtknc0 [ 0 ] , & rtB . bftm5ocvno [ 0 ] , & rtB . fp54rsi3hk [ 0 ] , &
rtB . kgmxbpmzzy [ 0 ] , & rtB . copfzvyvfn [ 0 ] , & rtB . omkpqlajlz [ 0 ]
, & rtB . icmhkhsb0o , & rtB . orlelyhfjl , & rtB . nhcvscc4t0 [ 0 ] , & rtB
. kunmel5bx4 [ 0 ] , & rtB . kainbdj3jznl [ 0 ] , & rtB . bdrmalqcon [ 0 ] ,
& rtB . npsuhx1330 [ 0 ] , & rtB . kqrxmtokjd [ 0 ] , & rtB . bjhstbmrsn , &
rtB . osqwflveuv , & rtB . bp0afaxpp5 , & rtB . j1stuyzs1t [ 0 ] , & rtB .
jv53lpnvpb [ 0 ] , & rtB . jz0qdcsmmmwh [ 15 ] . m05clr3gxy [ 0 ] , & rtB .
...
rude_defl ) , 1 , 25 , 0 } , { "alphas" , rt_offsetof (
struct_jutHZYEwOoNeidUZKCLQ8B , alphas ) , 1 , 26 , 0 } , { "betas" ,
rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , betas ) , 1 , 27 , 0 } , {
"CFx" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CFx ) , 1 , 28 , 0 } ,
{ "CFy" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CFy ) , 1 , 28 , 0 }
, { "CFz" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CFz ) , 1 , 28 , 0
} , { "CMx" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CMx ) , 1 , 28 ,
0 } , { "CMy" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CMy ) , 1 , 28
, 0 } , { "CMz" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , CMz ) , 1 ,
28 , 0 } , { "Xs_LE" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B , Xs_LE )
, 1 , 5 , 0 } , { "Ys_LE" , rt_offsetof ( struct_jutHZYEwOoNeidUZKCLQ8B ,
Ys_LE ) , 1 , 5 , 0 } , { "Zs_LE" , rt_offsetof (
struct_jutHZYEwOoNeidUZKCLQ8B , Zs_LE ) , 1 , 5 , 0 } , { "flap_defl" ,
rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , flap_defl ) , 1 , 29 , 0 } , {
"alphas" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , alphas ) , 1 , 30 ,
0 } , { "V_infs" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , V_infs ) , 1
, 31 , 0 } , { "DEP_J" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , DEP_J
) , 1 , 32 , 0 } , { "alpha_induced" , rt_offsetof (
struct_X4VfLKyPh2o5xFDym0ZDqD , alpha_induced ) , 1 , 33 , 0 } , {
"V_induced" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , V_induced ) , 1 ,
33 , 0 } , { "Xs_LE" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD , Xs_LE )
, 1 , 5 , 0 } , { "Ys_LE" , rt_offsetof ( struct_X4VfLKyPh2o5xFDym0ZDqD ,
Ys_LE ) , 1 , 5 , 0 } , { "Zs_LE" , rt_offsetof (
struct_X4VfLKyPh2o5xFDym0ZDqD , Zs_LE ) , 1 , 5 , 0 } , { "flap_defl" ,
rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , flap_defl ) , 1 , 29 , 0 } , {
"alphas" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , alphas ) , 1 , 30 ,
0 } , { "V" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , V ) , 1 , 31 , 0
} , { "DEP_J" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , DEP_J ) , 1 ,
32 , 0 } , { "CD" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CD ) , 1 ,
34 , 0 } , { "CS" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CS ) , 1 ,
34 , 0 } , { "CL" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CL ) , 1 ,
34 , 0 } , { "CMx" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CMx ) , 1
, 34 , 0 } , { "CMy" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CMy ) ,
1 , 34 , 0 } , { "CMz" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , CMz )
, 1 , 34 , 0 } , { "LE_Xs" , rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE ,
LE_Xs ) , 1 , 35 , 0 } , { "LE_Ys" , rt_offsetof (
struct_IzJ4J0FtAuhnGd5tRgSyHE , LE_Ys ) , 1 , 35 , 0 } , { "LE_Zs" ,
rt_offsetof ( struct_IzJ4J0FtAuhnGd5tRgSyHE , LE_Zs ) , 1 , 35 , 0 } , {
"ail_defl" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , ail_defl ) , 1 , 36
, 0 } , { "alphas" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , alphas ) ,
1 , 30 , 0 } , { "V" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , V ) , 1 ,
31 , 0 } , { "DEP_J" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , DEP_J ) ,
1 , 32 , 0 } , { "CD" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CD ) , 1
, 37 , 0 } , { "CS" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CS ) , 1 ,
37 , 0 } , { "CL" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CL ) , 1 ,
37 , 0 } , { "CMx" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CMx ) , 1 ,
37 , 0 } , { "CMy" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CMy ) , 1 ,
37 , 0 } , { "CMz" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , CMz ) , 1 ,
37 , 0 } , { "LE_Xs" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , LE_Xs ) ,
1 , 31 , 0 } , { "LE_Ys" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH , LE_Ys
) , 1 , 31 , 0 } , { "LE_Zs" , rt_offsetof ( struct_yWIZFWBbymsS8L1W0LWVH ,
LE_Zs ) , 1 , 31 , 0 } , { "V_vec" , rt_offsetof (
struct_fnuCCPniuRknyr94YhzxZ , V_vec ) , 0 , 39 , 0 } , { "T_vec" ,
rt_offsetof ( struct_fnuCCPniuRknyr94YhzxZ , T_vec ) , 0 , 40 , 0 } , {
"rpm_gird" , rt_offsetof ( struct_fnuCCPniuRknyr94YhzxZ , rpm_gird ) , 0 , 41
, 0 } , { "V" , rt_offsetof ( struct_e4KmvBjsHkMILSnyqn1SNH , V ) , 0 , 43 ,
0 } , { "actf" , rt_offsetof ( struct_e4KmvBjsHkMILSnyqn1SNH , actf ) , 0 ,
43 , 0 } , { "J" , rt_offsetof ( struct_nC6b04CeB5t4pOaoQVXKo , J ) , 0 , 38
, 0 } , { "C_T" , rt_offsetof ( struct_nC6b04CeB5t4pOaoQVXKo , C_T ) , 0 , 38
, 0 } , { "C_Q" , rt_offsetof ( struct_nC6b04CeB5t4pOaoQVXKo , C_Q ) , 0 , 38
, 0 } , { "rpm_lookup" , rt_offsetof ( struct_nC6b04CeB5t4pOaoQVXKo ,
rpm_lookup ) , 7 , 42 , 0 } , { "limits" , rt_offsetof (
struct_nC6b04CeB5t4pOaoQVXKo , limits ) , 8 , 42 , 0 } , { "V_low_lim" ,
rt_offsetof ( struct_jgnmaTiP1kwpD95SOjXYyE , V_low_lim ) , 0 , 44 , 0 } , {
"T_low_lim" , rt_offsetof ( struct_jgnmaTiP1kwpD95SOjXYyE , T_low_lim ) , 0 ,
44 , 0 } , { "V_up_lim" , rt_offsetof ( struct_jgnmaTiP1kwpD95SOjXYyE ,
V_up_lim ) , 0 , 35 , 0 } , { "T_up_lim" , rt_offsetof (
struct_jgnmaTiP1kwpD95SOjXYyE , T_up_lim ) , 0 , 35 , 0 } , { "limits" ,
rt_offsetof ( struct_OvGmMrPqfNtzpqofYdArSB , limits ) , 10 , 42 , 0 } , {
"V_vec" , rt_offsetof ( struct_OvGmMrPqfNtzpqofYdArSB , V_vec ) , 0 , 45 , 0
} , { "T_vec" , rt_offsetof ( struct_OvGmMrPqfNtzpqofYdArSB , T_vec ) , 0 ,
46 , 0 } , { "Q_grid" , rt_offsetof ( struct_OvGmMrPqfNtzpqofYdArSB , Q_grid
) , 0 , 47 , 0 } , { "P_grid" , rt_offsetof ( struct_OvGmMrPqfNtzpqofYdArSB ,
P_grid ) , 0 , 47 , 0 } , { "beta" , rt_offsetof (
struct_ledTFd3zOA1QjIJZGqbRtH , beta ) , 0 , 45 , 0 } , { "aoa" , rt_offsetof
( struct_ledTFd3zOA1QjIJZGqbRtH , aoa ) , 0 , 48 , 0 } , { "ref_CG" ,
rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , ref_CG ) , 0 , 49 , 0 } , {
"CD" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CD ) , 1 , 50 , 0 } , {
"CS" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CS ) , 1 , 50 , 0 } , {
"CL" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CL ) , 1 , 50 , 0 } , {
"CMx" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CMx ) , 1 , 50 , 0 } ,
{ "CMy" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CMy ) , 1 , 50 , 0 }
, { "CMz" , rt_offsetof ( struct_ledTFd3zOA1QjIJZGqbRtH , CMz ) , 1 , 50 , 0
...
rtwCAPI_MATRIX_COL_MAJOR , 22 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 8 , 2
, 0 } , { rtwCAPI_VECTOR , 24 , 2 , 0 } , { rtwCAPI_VECTOR , 26 , 2 , 0 } , {
rtwCAPI_VECTOR , 28 , 2 , 0 } , { rtwCAPI_VECTOR , 30 , 2 , 0 } , {
rtwCAPI_VECTOR , 10 , 2 , 0 } , { rtwCAPI_VECTOR , 32 , 2 , 0 } , {
...
, 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 50 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR_ND , 52 , 4 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 56
, 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 58 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 36 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 60 , 2
, 0 } , { rtwCAPI_MATRIX_COL_MAJOR_ND , 62 , 5 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR_ND , 67 , 5 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 42
, 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 72 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR_ND , 74 , 5 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 79
, 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 81 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 83 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 85 , 2
, 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 4 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR
, 87 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 34 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 38 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 89 , 2
, 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 91 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 40 , 2 , 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 28 , 2
, 0 } , { rtwCAPI_MATRIX_COL_MAJOR , 93 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 95 , 2 , 0 } } ; static const uint_T
rtDimensionArray [ ] = { 6 , 1 , 2 , 1 , 1 , 1 , 12 , 1 , 3 , 1 , 1 , 16 , 1
, 14 , 3 , 12 , 16 , 1 , 3 , 16 , 3 , 3 , 3 , 7 , 10 , 1 , 1 , 12 , 1 , 3 , 1
, 8 , 4 , 1 , 1 , 6 , 1 , 2 , 13 , 1 , 15 , 1 , 1 , 5 , 70 , 1 , 1 , 10 , 1 ,
13 , 1 , 9 , 10 , 13 , 9 , 16 , 5 , 1 , 1 , 25 , 1 , 7 , 5 , 25 , 2 , 7 , 16
, 5 , 25 , 2 , 7 , 5 , 7 , 1 , 7 , 25 , 2 , 7 , 2 , 46 , 1 , 43 , 1 , 91 , 1
, 43 , 91 , 1 , 19 , 41 , 1 , 13 , 41 , 13 , 15 , 3 , 14 } ; static const
...
rtBlockSignals , 76 , rtRootInputs , 1 , rtRootOutputs , 1 } , {
rtBlockParameters , 165 , rtModelParameters , 14 } , { ( NULL ) , 0 } , {
rtDataTypeMap , rtDimensionMap , rtFixPtMap , rtElementMap , rtSampleTimeMap
, rtDimensionArray } , "float" , { 3551389010U , 350159362U , 2742891967U ,
2109796234U } , ( NULL ) , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ;
