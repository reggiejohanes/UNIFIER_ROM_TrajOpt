...
MODEL                = UNIFIER_dyn
MODULES              = UNIFIER_dyn.c UNIFIER_dyn_capi.c UNIFIER_dyn_data.c UNIFIER_dyn_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = UNIFIER_dyn.exe
MAKEFILE             = UNIFIER_dyn.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023b
START_DIR            = D:/TUDelft/Year2/Thesis/UNIFIER_ROM_TrajOpt/data
...
OPTIMIZATION_FLAGS      = 
ADDITIONAL_LDFLAGS      = 
DEFINES_CUSTOM          = -DEXT_MODE -DIS_RAPID_ACCEL -DRACCEL_ENABLE_PARALLEL_EXECUTION -DRACCEL_PARALLEL_EXECUTION_NUM_THREADS=4 -DRACCEL_NUM_PARALLEL_NODES=9 -DRACCEL_PARALLEL_SIMULATOR_TYPE=0 
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = UNIFIER_dyn_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/UNIFIER_dyn \
