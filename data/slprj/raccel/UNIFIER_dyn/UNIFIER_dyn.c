...
[ brnrrcfc0x ] . gbstdhmylq * iuttlsfwrg + rtP . utest [ 4 ] ; } rtB .
eljuwfhp1f [ brnrrcfc0x ] = e4d3jspw35 ; } } void b4xsnziie2TID1 ( int32_T
brnrrcfc0x ) { rtB . p5rpnypkdo [ brnrrcfc0x ] . gbstdhmylq =
muDoubleScalarTan ( rtP . p5rpnypkdo . K_slope_Gain * rtP . utest [ 5 ] ) ; }
...
"52c6e0b2-425a-4473-bf5d-8f01d705525f" , sigComplexity , & sigDims ,
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"4f68b39d-0b72-4a7e-8eb8-f208927a9a9b" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
InstanceMap . fullPath , "84b20b5a-45f0-47fc-9b1e-a2568ee99ab4" ,
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"b3d04629-3713-4ed1-a173-c407c7d8bc19" , sigComplexity , & sigDims ,
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "2fc3cd02-2e4e-4822-87f0-2c539b93aa91" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"f31c30cd-258c-47f8-bb1f-70a11094d844" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "b2250af0-38e4-4c4b-a299-520bee76bb39" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"0fddc377-32cd-412e-a855-d461915498b4" , sigComplexity , & sigDims ,
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "8859fc39-d2d9-493a-8e45-9a2da318b106" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"961cd30f-4a2a-4e4e-b161-fe98a5343ff4" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"21ffd948-4536-4369-84c2-a9e1bb9f5781" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"24e9f267-175a-4a06-a9f9-74b4dec0d27b" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
gs5wgqurd1 [ 16 ] ; real32_T njokkaqa44 [ 16 ] ; real32_T fcnqqv3bsy [ 5 ] ;
...
"eo4s0qr2ut" ) ; for ( i_p = 0 ; i_p < 12 ; i_p ++ ) { rtB . ie2rqterc2 [ i_p
] = ( real32_T ) rtB . etlvxwxtcy [ i_p ] ; } jtk2ho12tm [ 0 ] = rtB .
ie2rqterc2 [ 5 ] ; jtk2ho12tm [ 1 ] = rtB . ie2rqterc2 [ 4 ] ; jtk2ho12tm [ 2
] = rtB . ie2rqterc2 [ 3 ] ; jtk2ho12tm [ 3 ] = rtB . ie2rqterc2 [ 2 ] ;
jtk2ho12tm [ 4 ] = rtB . ie2rqterc2 [ 1 ] ; for ( i_p = 0 ; i_p < 5 ; i_p ++
) { i21j1alng4 [ i_p ] = plook_u32ff_lincpa ( jtk2ho12tm [ i_p ] , rtP .
dp_WING_root . DEP_J , 6U , & m25svtzs1a [ i_p ] , & rtDW . d45t54zzh0 [ i_p
] ) ; } frac [ 0 ] = rtB . ayw0otszrq ; bpIndex [ 0 ] = rtB . g53iqbai0i ;
for ( i_p = 0 ; i_p < 5 ; i_p ++ ) { frac [ 1 ] = fcnqqv3bsy [ i_p ] ; frac [
2 ] = pwsv0izi4l [ i_p ] ; frac [ 3 ] = m25svtzs1a [ i_p ] ; bpIndex [ 1 ] =
glk5ydjkx2 [ i_p ] ; bpIndex [ 2 ] = ii2emm2n0y [ i_p ] ; bpIndex [ 3 ] =
i21j1alng4 [ i_p ] ; f0ykxvjp2e = rtP . Constant8_Value_dj5ncyqbcf [ i_p ] ;
if ( f0ykxvjp2e > 4.0 ) { bpIndex [ 4 ] = 4U ; } else if ( f0ykxvjp2e >= 0.0
) { bpIndex [ 4 ] = ( uint32_T ) f0ykxvjp2e ; } else { bpIndex [ 4 ] = 0U ; }
kgeeoq3i0q [ i_p ] = intrp4d_fu32fla_pw ( bpIndex , frac , & rtP .
dp_WING_root . CD [ 1750U * bpIndex [ 4 ] ] , rtP .
InterpolationUsingPrelookup1_dimSize , rtP .
...
plook_u32ff_lincpa ( rtB . ie2rqterc2 [ 1 ] , rtP . dp_WING_tip . DEP_J , 6U
, & d1dhbqr5yc [ 0 ] , & rtDW . cv4ea1x5bf [ 0 ] ) ; ok0ziasf2d_idx_1 =
plook_u32ff_lincpa ( rtB . ie2rqterc2 [ 0 ] , rtP . dp_WING_tip . DEP_J , 6U
...
i_p < 5 ; i_p ++ ) { bpIndex_e [ i_p ] = plook_u32ff_lincpa ( rtB .
ie2rqterc2 [ i_p + 6 ] , rtP . dp_WING_root . DEP_J , 6U , & gzu1zm2zul [ i_p
] , & rtDW . jevgaddxph [ i_p ] ) ; } frac_j [ 0 ] = rtB . gbccn4rvbj ;
bpIndex_j [ 0 ] = rtB . bqft1jkk0z ; for ( i_p = 0 ; i_p < 5 ; i_p ++ ) {
frac_j [ 1 ] = jtk2ho12tm [ i_p ] ; frac_j [ 2 ] = p52cvq2maf [ i_p ] ;
frac_j [ 3 ] = gzu1zm2zul [ i_p ] ; bpIndex_j [ 1 ] = bpIndex [ i_p ] ;
bpIndex_j [ 2 ] = bpIndex_p [ i_p ] ; bpIndex_j [ 3 ] = bpIndex_e [ i_p ] ;
f0ykxvjp2e = rtP . Constant8_Value_kwpfdqsyq1 [ i_p ] ; if ( f0ykxvjp2e > 4.0
) { bpIndex_j [ 4 ] = 4U ; } else if ( f0ykxvjp2e >= 0.0 ) { bpIndex_j [ 4 ]
= ( uint32_T ) f0ykxvjp2e ; } else { bpIndex_j [ 4 ] = 0U ; } ktfulnpz4m [
i_p ] = intrp4d_fu32fla_pw ( bpIndex_j , frac_j , & rtP . dp_WING_root . CD [
1750U * bpIndex_j [ 4 ] ] , rtP .
InterpolationUsingPrelookup1_dimSize_jgranlzjdr , rtP .
InterpolationUsingPrelookup1_maxIndex_m1elfxqfrm ) ; } h2f22pqghw_idx_0 =
...
plook_u32ff_lincpa ( rtB . ie2rqterc2 [ 10 ] , rtP . dp_WING_tip . DEP_J , 6U
, & orrknllzxd [ 0 ] , & rtDW . pb5bsdxxpa [ 0 ] ) ; mwzdolw5gj_idx_1 =
plook_u32ff_lincpa ( rtB . ie2rqterc2 [ 11 ] , rtP . dp_WING_tip . DEP_J , 6U
...
i_p ] ) ; } for ( i_p = 0 ; i_p < 16 ; i_p ++ ) { ep5pua1w1i [ i_p ] =
look1_iflf_pbinlcpw ( rtP . Constant7_Value [ i_p ] , rtP .
uDLookupTable2_bp01Data , & rtB . ie2rqterc2 [ 3 ] , & rtDW . eewvdaqf4r [
i_p ] , 5U ) ; } for ( i_p = 0 ; i_p < 16 ; i_p ++ ) { p4lqtpxnj2 [ i_p ] =
...
real_T gdtrsjcewr_idx_1 ; real_T hjttkybh1q ; real_T jutsbkzgmp ; real_T
lpaiahwg3w_idx_1 ; real_T lpaiahwg3w_idx_2 ; real_T lw4w2egmki ; real_T
mgqm32zwav_idx_0 ; real_T mgqm32zwav_idx_1 ; real_T ngmxr5x0vt_idx_0 ; real_T
ngmxr5x0vt_idx_1 ; real_T o4in22cuua_idx_0 ; real_T o4in22cuua_idx_1 ;
int32_T i ; real32_T frac [ 2 ] ; real32_T frac_e [ 2 ] ; real32_T frac_i [ 2
] ; real32_T frac_m [ 2 ] ; real32_T frac_p [ 2 ] ; real32_T dym5ca3jhv_idx_0
; real32_T dym5ca3jhv_idx_1 ; real32_T dym5ca3jhv_idx_2 ; real32_T fftpwkdb2l
; real32_T ifn41umu44 ; real32_T oxl1en4taa ; real32_T tmp ; real32_T tmp_i ;
uint32_T bpIndex [ 2 ] ; uint32_T bpIndex_e [ 2 ] ; uint32_T bpIndex_i [ 2 ]
; uint32_T bpIndex_m [ 2 ] ; uint32_T bpIndex_p [ 2 ] ; uint32_T d1pa2cabjk ;
uint32_T lfhn4gnsr4 ; mgqm32zwav_idx_0 = ( rtP . xtest [ 3 ] * rtP . xtest [
3 ] + rtP . xtest [ 4 ] * rtP . xtest [ 4 ] ) + rtP . xtest [ 5 ] * rtP .
xtest [ 5 ] ; if ( ssIsMajorTimeStep ( rtS ) ) { if ( rtDW . lmdux514h1 != 0
) { ssSetBlockStateForSolverChangedAtMajorStep ( rtS ) ;
ssSetContTimeOutputInconsistentWithStateAtMajorStep ( rtS ) ; rtDW .
lmdux514h1 = 0 ; } hjttkybh1q = muDoubleScalarSqrt ( mgqm32zwav_idx_0 ) ; }
else if ( mgqm32zwav_idx_0 < 0.0 ) { hjttkybh1q = - muDoubleScalarSqrt (
muDoubleScalarAbs ( mgqm32zwav_idx_0 ) ) ; rtDW . lmdux514h1 = 1 ; } else {
hjttkybh1q = muDoubleScalarSqrt ( mgqm32zwav_idx_0 ) ; } mgqm32zwav_idx_0 =
hjttkybh1q + rtP . Constant1_Value ; if ( - rtP . xtest [ 2 ] > rtP .
Limitaltitudetotroposhere_UpperSat ) { jutsbkzgmp = rtP .
Limitaltitudetotroposhere_UpperSat ; } else if ( - rtP . xtest [ 2 ] < rtP .
Limitaltitudetotroposhere_LowerSat ) { jutsbkzgmp = rtP .
Limitaltitudetotroposhere_LowerSat ; } else { jutsbkzgmp = - rtP . xtest [ 2
] ; } hjttkybh1q = rtP . SeaLevelTemperature_Value - rtP . LapseRate_Gain *
jutsbkzgmp ; d3eatf34tr = rtP . uT0_Gain * hjttkybh1q ; lw4w2egmki = rtP .
AltitudeofTroposphere_Value - ( - rtP . xtest [ 2 ] ) ; if ( ( d3eatf34tr <
0.0 ) && ( rtP . Constant_Value > muDoubleScalarFloor ( rtP . Constant_Value
) ) ) { jutsbkzgmp = - muDoubleScalarPower ( - d3eatf34tr , rtP .
Constant_Value ) ; } else { jutsbkzgmp = muDoubleScalarPower ( d3eatf34tr ,
rtP . Constant_Value ) ; } if ( lw4w2egmki > rtP .
...
LimitaltitudetoStratosphere_LowerSat ; } rtB . jefg5cifsj = jutsbkzgmp /
...
muDoubleScalarSqrt ( hjttkybh1q ) ; } hjttkybh1q = mgqm32zwav_idx_0 *
d3eatf34tr ; d3eatf34tr = look1_plinlxpw ( hjttkybh1q , rtP . dp_HTU . limits
. V_up_lim , rtP . dp_HTU . limits . T_up_lim , & rtDW . fiq4gqvmys , 4U ) ;
jutsbkzgmp = look1_plinlcpw ( rtP . utest [ 6 ] , rtP .
...
, 1 , "b4xsnziie2TID1" ) ; rtB . lxkh42xndm [ 0 ] = ( real32_T ) rtP . xtest
[ 3 ] ; rtB . lcnor15erx [ 0 ] = ( real32_T ) rtP . xtest [ 9 ] ; rtB .
lxkh42xndm [ 1 ] = ( real32_T ) rtP . xtest [ 4 ] ; rtB . lcnor15erx [ 1 ] =
( real32_T ) rtP . xtest [ 10 ] ; rtB . lxkh42xndm [ 2 ] = ( real32_T ) rtP .
xtest [ 5 ] ; rtB . lcnor15erx [ 2 ] = ( real32_T ) rtP . xtest [ 11 ] ; rtB
. lofyrvcfpk = ( real32_T ) mgqm32zwav_idx_0 ; lw4w2egmki = rtP . xtest [ 4 ]
/ mgqm32zwav_idx_0 ; if ( lw4w2egmki > 1.0 ) { lw4w2egmki = 1.0 ; } else if (
lw4w2egmki < - 1.0 ) { lw4w2egmki = - 1.0 ; } rtB . jdptrpq5vl = ( real32_T )
muDoubleScalarAsin ( lw4w2egmki ) ; rtB . bmyhiptik5 = ( real32_T )
muDoubleScalarAtan2 ( rtP . xtest [ 5 ] , rtP . xtest [ 3 ] ) ; rtB .
ecjaklyjaq = ( real32_T ) rtB . jefg5cifsj ; if ( rtP . utest [ 0 ] > rtP .
Saturation_UpperSat ) { rtB . nycx5qzthq [ 0 ] = ( real32_T ) rtP .
Saturation_UpperSat ; } else if ( rtP . utest [ 0 ] < rtP .
Saturation_LowerSat ) { rtB . nycx5qzthq [ 0 ] = ( real32_T ) rtP .
Saturation_LowerSat ; } else { rtB . nycx5qzthq [ 0 ] = ( real32_T ) rtP .
utest [ 0 ] ; } if ( - rtP . utest [ 0 ] > rtP . Saturation1_UpperSat ) { rtB
. nycx5qzthq [ 1 ] = ( real32_T ) rtP . Saturation1_UpperSat ; } else if ( -
rtP . utest [ 0 ] < rtP . Saturation1_LowerSat ) { rtB . nycx5qzthq [ 1 ] = (
real32_T ) rtP . Saturation1_LowerSat ; } else { rtB . nycx5qzthq [ 1 ] = (
real32_T ) - rtP . utest [ 0 ] ; } lw4w2egmki = rtP . utest [ 2 ] - rtP .
utest [ 1 ] ; if ( lw4w2egmki > rtP . Saturation2_UpperSat ) { rtB .
nycx5qzthq [ 2 ] = ( real32_T ) rtP . Saturation2_UpperSat ; } else if (
lw4w2egmki < rtP . Saturation2_LowerSat ) { rtB . nycx5qzthq [ 2 ] = (
real32_T ) rtP . Saturation2_LowerSat ; } else { rtB . nycx5qzthq [ 2 ] = (
real32_T ) lw4w2egmki ; } lw4w2egmki = rtP . utest [ 1 ] + rtP . utest [ 2 ]
; if ( lw4w2egmki > rtP . Saturation3_UpperSat ) { rtB . nycx5qzthq [ 3 ] = (
real32_T ) rtP . Saturation3_UpperSat ; } else if ( lw4w2egmki < rtP .
Saturation3_LowerSat ) { rtB . nycx5qzthq [ 3 ] = ( real32_T ) rtP .
Saturation3_LowerSat ; } else { rtB . nycx5qzthq [ 3 ] = ( real32_T )
lw4w2egmki ; } if ( rtP . utest [ 3 ] > rtP . Saturation6_UpperSat ) { rtB .
nycx5qzthq [ 4 ] = ( real32_T ) rtP . Saturation6_UpperSat ; } else if ( rtP
. utest [ 3 ] < rtP . Saturation6_LowerSat ) { rtB . nycx5qzthq [ 4 ] = (
real32_T ) rtP . Saturation6_LowerSat ; } else { rtB . nycx5qzthq [ 4 ] = (
real32_T ) rtP . utest [ 3 ] ; } if ( rtP . utest [ 3 ] > rtP .
Saturation4_UpperSat ) { rtB . nycx5qzthq [ 5 ] = ( real32_T ) rtP .
Saturation4_UpperSat ; } else if ( rtP . utest [ 3 ] < rtP .
Saturation4_LowerSat ) { rtB . nycx5qzthq [ 5 ] = ( real32_T ) rtP .
Saturation4_LowerSat ; } else { rtB . nycx5qzthq [ 5 ] = ( real32_T ) rtP .
utest [ 3 ] ; } rtB . hktdndemaa = ( real32_T ) rtP .
Constant_Value_kpkyenjwdq ; parallel_for ( 16 , jgo5lugg00TID1 , 1 ,
"jgo5lugg00TID1" ) ; parallel_for ( 14 , f53wtq1cerTID1 , 1 ,
"f53wtq1cerTID1" ) ; dym5ca3jhv_idx_0 = ( real32_T ) rtP . dp_FUSE_FIN .
ref_CG [ 0 ] - ( real32_T ) rtP . xyz_cg [ 0 ] ; dym5ca3jhv_idx_1 = (
real32_T ) rtP . dp_FUSE_FIN . ref_CG [ 1 ] - ( real32_T ) rtP . xyz_cg [ 1 ]
; dym5ca3jhv_idx_2 = ( real32_T ) rtP . dp_FUSE_FIN . ref_CG [ 2 ] - (
real32_T ) rtP . xyz_cg [ 2 ] ; muDoubleScalarSinCos ( rtB . bmyhiptik5 , &
mgqm32zwav_idx_0 , & d3eatf34tr ) ; muDoubleScalarSinCos ( rtB . jdptrpq5vl ,
& mgqm32zwav_idx_1 , & gdtrsjcewr_idx_1 ) ; e5rpw1ek1v [ 0 ] = d3eatf34tr *
gdtrsjcewr_idx_1 ; e5rpw1ek1v [ 1 ] = - ( d3eatf34tr * mgqm32zwav_idx_1 ) ;
e5rpw1ek1v [ 2 ] = - mgqm32zwav_idx_0 ; e5rpw1ek1v [ 3 ] = mgqm32zwav_idx_1 ;
e5rpw1ek1v [ 4 ] = gdtrsjcewr_idx_1 ; e5rpw1ek1v [ 5 ] = rtP .
Constant_Value_ll1hqpke5l ; e5rpw1ek1v [ 6 ] = mgqm32zwav_idx_0 *
gdtrsjcewr_idx_1 ; e5rpw1ek1v [ 7 ] = - ( mgqm32zwav_idx_0 * mgqm32zwav_idx_1
) ; e5rpw1ek1v [ 8 ] = d3eatf34tr ; d1pa2cabjk = plook_u32ff_linxp ( rtB .
jdptrpq5vl , rtP . Prelookup_BreakpointsData , 12U , & ifn41umu44 , & rtDW .
khbxaboxwb ) ; lfhn4gnsr4 = plook_u32ff_linxp ( rtB . bmyhiptik5 , rtP .
Prelookup1_BreakpointsData , 14U , & oxl1en4taa , & rtDW . djzedhv1ik ) ;
frac [ 0 ] = ifn41umu44 ; frac [ 1 ] = oxl1en4taa ; bpIndex [ 0 ] =
d1pa2cabjk ; bpIndex [ 1 ] = lfhn4gnsr4 ; frac_p [ 0 ] = ifn41umu44 ; frac_p
[ 1 ] = oxl1en4taa ; bpIndex_p [ 0 ] = d1pa2cabjk ; bpIndex_p [ 1 ] =
lfhn4gnsr4 ; fftpwkdb2l = rtB . lofyrvcfpk * rtB . lofyrvcfpk ; tmp =
intrp2d_fu32fl_pw ( bpIndex_p , frac_p , rtP . dp_FUSE_FIN . CS , 13U ) ;
tmp_i = - intrp2d_fu32fl_pw ( bpIndex , frac , rtP . dp_FUSE_FIN . CD , 13U )
; for ( i = 0 ; i < 3 ; i ++ ) { rtB . f5f1ypai11 [ i ] = ( ( ( real32_T )
e5rpw1ek1v [ 3 * i + 1 ] * tmp + ( real32_T ) e5rpw1ek1v [ 3 * i ] * tmp_i )
+ ( real32_T ) e5rpw1ek1v [ 3 * i + 2 ] * - rtP . Constant_Value_dggd0yls2s )
* fftpwkdb2l * rtB . ecjaklyjaq * rtP . Gain_Gain_ngpzxxezsf ; } frac_e [ 0 ]
= ifn41umu44 ; frac_e [ 1 ] = oxl1en4taa ; bpIndex_e [ 0 ] = d1pa2cabjk ;
bpIndex_e [ 1 ] = lfhn4gnsr4 ; frac_i [ 0 ] = ifn41umu44 ; frac_i [ 1 ] =
oxl1en4taa ; bpIndex_i [ 0 ] = d1pa2cabjk ; bpIndex_i [ 1 ] = lfhn4gnsr4 ;
frac_m [ 0 ] = ifn41umu44 ; frac_m [ 1 ] = oxl1en4taa ; bpIndex_m [ 0 ] =
d1pa2cabjk ; bpIndex_m [ 1 ] = lfhn4gnsr4 ; mgqm32zwav_idx_0 = rtP . S / 2.0
; rtB . l3mgpdtrrg [ 0 ] = intrp2d_fu32fl_pw ( bpIndex_e , frac_e , rtP .
dp_FUSE_FIN . CMx , 13U ) * fftpwkdb2l * rtP . Constant_Value_exkenlsy3u [ 0
] * rtB . ecjaklyjaq * mgqm32zwav_idx_0 + ( dym5ca3jhv_idx_1 * rtB .
f5f1ypai11 [ 2 ] - rtB . f5f1ypai11 [ 1 ] * dym5ca3jhv_idx_2 ) ; rtB .
l3mgpdtrrg [ 1 ] = intrp2d_fu32fl_pw ( bpIndex_i , frac_i , rtP . dp_FUSE_FIN
. CMy , 13U ) * fftpwkdb2l * rtP . Constant_Value_exkenlsy3u [ 1 ] * rtB .
ecjaklyjaq * mgqm32zwav_idx_0 + ( rtB . f5f1ypai11 [ 0 ] * dym5ca3jhv_idx_2 -
...
f5f1ypai11 [ 0 ] * dym5ca3jhv_idx_1 ) ; dym5ca3jhv_idx_0 = rtB . nycx5qzthq [
4 ] ; dym5ca3jhv_idx_1 = rtB . nycx5qzthq [ 5 ] ; for ( i = 0 ; i < 8 ; i ++
) { e5m4lakd0l [ i ] = rtP . Constant_Value_izgjegg0j4 [ i ] *
dym5ca3jhv_idx_0 ; e5m4lakd0l [ i + 8 ] = rtP . Constant1_Value_meik51c4df [
i ] * dym5ca3jhv_idx_1 ; } for ( i = 0 ; i < 5 ; i ++ ) { tmp_p [ i ] = rtP .
dp_VTAIL_INDUCED . flap_defl [ i ] ; } for ( i = 0 ; i < 16 ; i ++ ) { rtB .
nhcvscc4t0 [ i ] = plook_linxp ( e5m4lakd0l [ i ] , tmp_p , 4U , & rtB .
kunmel5bx4 [ i ] , & rtDW . luravducvq [ i ] ) ; } parallel_for ( 16 ,
cv3gln2abzTID1 , 1 , "cv3gln2abzTID1" ) ; dym5ca3jhv_idx_0 = rtB . nycx5qzthq
[ 2 ] ; dym5ca3jhv_idx_1 = rtB . nycx5qzthq [ 3 ] ; for ( i = 0 ; i < 8 ; i
++ ) { e5m4lakd0l [ i ] = rtP . Constant_Value_kx5dv3qh2a [ i ] *
dym5ca3jhv_idx_0 ; e5m4lakd0l [ i + 8 ] = rtP . Constant1_Value_dxjow4r24m [
i ] * dym5ca3jhv_idx_1 ; } for ( i = 0 ; i < 10 ; i ++ ) { tmp_e [ i ] = rtP
. dp_VTAIL . rude_defl [ i ] ; } for ( i = 0 ; i < 16 ; i ++ ) { rtB .
pmh50qaazg [ i ] = plook_linxp ( e5m4lakd0l [ i ] , tmp_e , 9U , & rtB .
mgyjrcfqfu [ i ] , & rtDW . e15temhbyp [ i ] ) ; } parallel_for ( 7 ,
d2dy1jnwgpTID1 , 1 , "d2dy1jnwgpTID1" ) ; rtB . g53iqbai0i =
plook_u32ff_lincpa ( rtB . nycx5qzthq [ 4 ] , rtP . dp_WING_root . flap_defl
, 4U , & rtB . ayw0otszrq , & rtDW . jseguf13yy ) ; rtB . jqfgyi5cqv =
plook_u32ff_lincpa ( rtB . nycx5qzthq [ 0 ] , rtP . dp_WING_tip . ail_defl ,
6U , & rtB . lkci5wisjr , & rtDW . cfngthrtfc ) ; parallel_for ( 7 ,
pg42w5emjtTID1 , 1 , "pg42w5emjtTID1" ) ; rtB . bqft1jkk0z =
plook_u32ff_lincpa ( rtB . nycx5qzthq [ 5 ] , rtP . dp_WING_root . flap_defl
, 4U , & rtB . gbccn4rvbj , & rtDW . k3rxirp2ci ) ; rtB . fu5nkfrvvl =
plook_u32ff_lincpa ( rtB . nycx5qzthq [ 1 ] , rtP . dp_WING_tip . ail_defl ,
6U , & rtB . igwg4uissg , & rtDW . nfqrlmtid3 ) ; muDoubleScalarSinCos ( rtB
. bmyhiptik5 , & o4in22cuua_idx_0 , & ngmxr5x0vt_idx_0 ) ;
muDoubleScalarSinCos ( rtB . jdptrpq5vl , & o4in22cuua_idx_1 , &
ngmxr5x0vt_idx_1 ) ; e5rpw1ek1v [ 0 ] = ngmxr5x0vt_idx_0 * ngmxr5x0vt_idx_1 ;
e5rpw1ek1v [ 1 ] = - ( ngmxr5x0vt_idx_0 * o4in22cuua_idx_1 ) ; e5rpw1ek1v [ 2
] = - o4in22cuua_idx_0 ; e5rpw1ek1v [ 3 ] = o4in22cuua_idx_1 ; e5rpw1ek1v [ 4
] = ngmxr5x0vt_idx_1 ; e5rpw1ek1v [ 5 ] = rtP . Constant_Value_ec1rbuxqhz ;
e5rpw1ek1v [ 6 ] = o4in22cuua_idx_0 * ngmxr5x0vt_idx_1 ; e5rpw1ek1v [ 7 ] = -
( o4in22cuua_idx_0 * o4in22cuua_idx_1 ) ; e5rpw1ek1v [ 8 ] = ngmxr5x0vt_idx_0
; tmp_i = - ( ( rtP . gear_drag_Value * rtB . hktdndemaa + rtP .
extra_drag_Value ) * rtB . ecjaklyjaq * rtP . Gain_Gain_jabdopn2nb * ( rtB .
lofyrvcfpk * rtB . lofyrvcfpk ) ) ; for ( i = 0 ; i < 3 ; i ++ ) { cx03kvbqie
[ 6 * i ] = rtP . I [ 3 * i ] ; cx03kvbqie [ 6 * i + 3 ] = rtP .
Constant2_Value [ 3 * i ] ; cx03kvbqie [ 6 * i + 1 ] = rtP . I [ 3 * i + 1 ]
; cx03kvbqie [ 6 * i + 4 ] = rtP . Constant2_Value [ 3 * i + 1 ] ; cx03kvbqie
[ 6 * i + 2 ] = rtP . I [ 3 * i + 2 ] ; cx03kvbqie [ 6 * i + 5 ] = rtP .
Constant2_Value [ 3 * i + 2 ] ; rtB . ejdl4n31el [ i ] = ( ( real32_T )
e5rpw1ek1v [ 3 * i + 1 ] * rtP . Constant1_Value_fodj5rxow1 + ( real32_T )
e5rpw1ek1v [ 3 * i ] * tmp_i ) + ( real32_T ) e5rpw1ek1v [ 3 * i + 2 ] * rtP
. Constant1_Value_fodj5rxow1 ; } mgqm32zwav_idx_0 = rtP . xtest [ 9 ] ;
jutsbkzgmp = rtP . xtest [ 10 ] ; o4in22cuua_idx_1 = rtP . xtest [ 11 ] ; for
( i = 0 ; i < 3 ; i ++ ) { rtB . kqrxmtokjd [ 3 * i ] = cx03kvbqie [ 6 * i ]
; rtB . kqrxmtokjd [ 3 * i + 1 ] = cx03kvbqie [ 6 * i + 1 ] ; rtB .
kqrxmtokjd [ 3 * i + 2 ] = cx03kvbqie [ 6 * i + 2 ] ; rtB . czxnr0doyy [ i ]
= ( cx03kvbqie [ i + 3 ] * mgqm32zwav_idx_0 + cx03kvbqie [ i + 9 ] *
jutsbkzgmp ) + cx03kvbqie [ i + 15 ] * o4in22cuua_idx_1 ; al44ljl512 [ i ] =
( cx03kvbqie [ i + 6 ] * jutsbkzgmp + cx03kvbqie [ i ] * mgqm32zwav_idx_0 ) +
cx03kvbqie [ i + 12 ] * o4in22cuua_idx_1 ; } rtB . cyv21phhbm [ 0 ] =
al44ljl512 [ 2 ] * rtP . xtest [ 10 ] - al44ljl512 [ 1 ] * rtP . xtest [ 11 ]
; rtB . cyv21phhbm [ 1 ] = al44ljl512 [ 0 ] * rtP . xtest [ 11 ] - al44ljl512
[ 2 ] * rtP . xtest [ 9 ] ; rtB . cyv21phhbm [ 2 ] = al44ljl512 [ 1 ] * rtP .
xtest [ 9 ] - al44ljl512 [ 0 ] * rtP . xtest [ 10 ] ; al44ljl512 [ 0 ] = rtP
. xtest [ 8 ] ; al44ljl512 [ 1 ] = rtP . xtest [ 7 ] ; muDoubleScalarSinCos (
rtP . xtest [ 8 ] , & mgqm32zwav_idx_0 , & kgibdgfrc0 [ 0 ] ) ;
muDoubleScalarSinCos ( rtP . xtest [ 7 ] , & lpaiahwg3w_idx_1 , & kgibdgfrc0
[ 1 ] ) ; muDoubleScalarSinCos ( rtP . xtest [ 6 ] , & lpaiahwg3w_idx_2 , &
kgibdgfrc0 [ 2 ] ) ; e5rpw1ek1v [ 0 ] = kgibdgfrc0 [ 0 ] * kgibdgfrc0 [ 1 ] ;
e5rpw1ek1v [ 1 ] = lpaiahwg3w_idx_1 * lpaiahwg3w_idx_2 * kgibdgfrc0 [ 0 ] -
mgqm32zwav_idx_0 * kgibdgfrc0 [ 2 ] ; e5rpw1ek1v [ 2 ] = lpaiahwg3w_idx_1 *
kgibdgfrc0 [ 2 ] * kgibdgfrc0 [ 0 ] + mgqm32zwav_idx_0 * lpaiahwg3w_idx_2 ;
e5rpw1ek1v [ 3 ] = mgqm32zwav_idx_0 * kgibdgfrc0 [ 1 ] ; e5rpw1ek1v [ 4 ] =
lpaiahwg3w_idx_1 * lpaiahwg3w_idx_2 * mgqm32zwav_idx_0 + kgibdgfrc0 [ 0 ] *
kgibdgfrc0 [ 2 ] ; e5rpw1ek1v [ 5 ] = lpaiahwg3w_idx_1 * kgibdgfrc0 [ 2 ] *
mgqm32zwav_idx_0 - kgibdgfrc0 [ 0 ] * lpaiahwg3w_idx_2 ; e5rpw1ek1v [ 6 ] = -
lpaiahwg3w_idx_1 ; e5rpw1ek1v [ 7 ] = kgibdgfrc0 [ 1 ] * lpaiahwg3w_idx_2 ;
e5rpw1ek1v [ 8 ] = kgibdgfrc0 [ 1 ] * kgibdgfrc0 [ 2 ] ; rtB . j1stuyzs1t [ 0
] = rtP . xtest [ 4 ] * rtP . xtest [ 11 ] - rtP . xtest [ 5 ] * rtP . xtest
[ 10 ] ; rtB . j1stuyzs1t [ 1 ] = rtP . xtest [ 5 ] * rtP . xtest [ 9 ] - rtP
. xtest [ 3 ] * rtP . xtest [ 11 ] ; rtB . j1stuyzs1t [ 2 ] = rtP . xtest [ 3
] * rtP . xtest [ 10 ] - rtP . xtest [ 4 ] * rtP . xtest [ 9 ] ; for ( i = 0
; i < 3 ; i ++ ) { muDoubleScalarSinCos ( rtP . xtest [ i + 6 ] , &
kgibdgfrc0 [ i ] , & al44ljl512 [ i ] ) ; rtB . jv53lpnvpb [ i ] = (
e5rpw1ek1v [ 3 * i + 1 ] * rtP . xtest [ 4 ] + e5rpw1ek1v [ 3 * i ] * rtP .
xtest [ 3 ] ) + e5rpw1ek1v [ 3 * i + 2 ] * rtP . xtest [ 5 ] ; } rtB .
bjhstbmrsn = ( kgibdgfrc0 [ 0 ] * rtP . xtest [ 10 ] + al44ljl512 [ 0 ] * rtP
. xtest [ 11 ] ) * ( kgibdgfrc0 [ 1 ] / al44ljl512 [ 1 ] ) + rtP . xtest [ 9
] ; rtB . osqwflveuv = ( kgibdgfrc0 [ 0 ] * rtP . xtest [ 10 ] + al44ljl512 [
0 ] * rtP . xtest [ 11 ] ) / al44ljl512 [ 1 ] ; rtB . bp0afaxpp5 = al44ljl512
[ 0 ] * rtP . xtest [ 10 ] - kgibdgfrc0 [ 0 ] * rtP . xtest [ 11 ] ;
mgqm32zwav_idx_0 = muDoubleScalarCos ( rtP . Inclination_Value ) ; jutsbkzgmp
= rtP . xtest [ 3 ] ; mgqm32zwav_idx_1 = rtP . xtest [ 11 ] ;
gdtrsjcewr_idx_1 = rtP . xyz_cg [ 1 ] ; for ( i = 0 ; i < 12 ; i ++ ) { rtB .
fp54rsi3hk [ i ] = ( ( rtP . Gain_Gain_jhzuipt41u [ i ] * gdtrsjcewr_idx_1 -
rtP . xyz_DEP [ 3 * i + 1 ] ) * mgqm32zwav_idx_1 + jutsbkzgmp ) *
mgqm32zwav_idx_0 ; } parallel_for ( 12 , eo4s0qr2utTID1 , 1 ,
"eo4s0qr2utTID1" ) ; o4in22cuua_idx_1 = rtP . Multiply_Gain * rtP . m ; for (
i = 0 ; i < 3 ; i ++ ) { rtB . omkpqlajlz [ i ] = ( e5rpw1ek1v [ i + 3 ] *
rtP . Constant_Value_kr4kbsbfsk + e5rpw1ek1v [ i ] * rtP .
Constant_Value_kr4kbsbfsk ) + e5rpw1ek1v [ i + 6 ] * o4in22cuua_idx_1 ; }
mgqm32zwav_idx_0 = look2_plinlxpw ( hjttkybh1q , rtB . gfknqoynom , rtP .
dp_HTU . V_vec , rtP . dp_HTU . T_vec , rtP . dp_HTU . P_grid , rtDW .
mitq3fljz5 , rtP . Plookup_maxIndex , 13U ) ; rtB . orlelyhfjl = rtP .
Gain_Gain_gmzj2h1bwx * mgqm32zwav_idx_0 ; UNUSED_PARAMETER ( tid ) ; } void
...
ssSetNumBlocks ( rtS , 716 ) ; ssSetNumBlockIO ( rtS , 83 ) ;
ssSetNumBlockParams ( rtS , 789 ) ; } void MdlInitializeSampleTimes ( void )
{ ssSetSampleTime ( rtS , 0 , 0.0 ) ; ssSetOffsetTime ( rtS , 0 , 1.0 ) ; }
void raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0 , 1932650260U ) ;
ssSetChecksumVal ( rtS , 1 , 2956544968U ) ; ssSetChecksumVal ( rtS , 2 ,
1350023336U ) ; ssSetChecksumVal ( rtS , 3 , 237793488U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
1932650260U ) ; ssSetChecksumVal ( rtS , 1 , 2956544968U ) ; ssSetChecksumVal
( rtS , 2 , 1350023336U ) ; ssSetChecksumVal ( rtS , 3 , 237793488U ) ; {
