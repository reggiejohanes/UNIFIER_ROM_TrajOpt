...
runconfig.ineq_gammin = deg2rad(-2);
runconfig.ineq_gammax = deg2rad(0);
...
runconfig.bndc_rodmin = convvel(0,'ft/min','m/s');
runconfig.bndc_rodmax = convvel(350,'ft/min','m/s');
...
elseif runconfig.ROMfile==2
    % trimname0="20240618_235415"; %ROM2-1, cruise, 0deg flap
    trimname0="20240618_235641"; %ROM2-1, cruise, 5deg flap
    % trimname0="20240618_235717"; %ROM2-1, cruise, 12deg flap
...
elseif runconfig.ROMfile==4
    % trimname0="20240619_001431"; %ROM4 (subset ROM2), cruise, 0deg flap
    trimname0="20240619_001520"; %ROM4 (subset ROM2), cruise, 5deg flap
    % trimname0="20240619_001538"; %ROM4 (subset ROM2), cruise, 12deg flap
elseif runconfig.ROMfile==5
    % trimname0="20240619_001642"; %ROM5 (subset ROM2), cruise, 0deg flap
    trimname0="20240619_001628"; %ROM5 (subset ROM2), cruise, 5deg flap
    % trimname0="20240619_001558"; %ROM5 (subset ROM2), cruise, 12deg flap
else
    error("Invalid ROM file setting")
end
...
elseif runconfig.ROMfile==2
    % trimname_f="20240618_235844"; %ROM2-1, landing, 0deg flap
    trimname_f="20240618_235804"; %ROM2-1, landing, 5deg flap
    % trimname_f="20240618_235744"; %ROM2-1, landing, 12deg flap
...
elseif runconfig.ROMfile==4
    % trimname_f="20240619_001400"; %ROM4, landing, 0deg flap
    trimname_f="20240619_001344"; %ROM4, landing, 5deg flap
    % trimname_f="20240619_001322"; %ROM4, landing, 12deg flap
elseif runconfig.ROMfile==5
    % trimname_f="20240619_001217"; %ROM5, landing, 0deg flap
    trimname_f="20240619_001241"; %ROM5, landing, 5deg flap
    % trimname_f="20240619_001300"; %ROM5, landing, 12deg flap
else
    error("Invalid ROM file setting")
end
...
% preview results
avgglideslope = atan2d(solution.X(1,2)-runconfig.zf,solution.X(end,1))
tf            = solution.tf
xf            = max(solution.X(:,1))
